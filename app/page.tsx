...
export default function Dashboard() {
	...
	const estadosChartData = data
		? [
				{
					name: data.descripcionEstados[1],
					value: data.resumenEstados.noIniciaron,
					color: "#f97316",
				},
				{
					name: data.descripcionEstados[2],
					value: data.resumenEstados.enProgreso,
					color: "#3b82f6",
				},
				{
					name: data.descripcionEstados[3],
					value: data.resumenEstados.autocensadas,
					color: "#22c55e",
				},
				{
					name: data.descripcionEstados[4],
	...
	const motivosChartData = data
		? [
				{
					name: data.descripcionMotivos[1],
					value: data.motivosEntrega[1],
					color: "#ec4899",
				},
				{
					name: data.descripcionMotivos[2],
					value: data.motivosEntrega[2],
					color: "#f43f5e",
				},
				{
					name: data.descripcionMotivos[3],
					value: data.motivosEntrega[3],
					color: "#06b6d4",
				},
				{
					name: data.descripcionMotivos[4],
					value: data.motivosEntrega[4],
					color: "#14b8a6",
				},
			]
		: [];
		...
		<div className="container mx-auto p-4 md:p-6">
			<div className="flex items-center gap-2 mb-6">
				...
				<h1 className="text-xl md:text-2xl lg:text-3xl font-bold">
					Censo en Línea de los Censos Nacionales 2025: XIII de Población, VIII
					de Vivienda y IV de Comunidades Indígenas
				</h1>
			</div>
				...
				<>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Distribución de viviendas según su estado actual en el censo
								</CardDescription>
							</CardHeader>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Distribución de viviendas según el motivo de entrega del
									Código Único de Vivienda
								</CardDescription>
							</CardHeader>
							<CardContent className="h-[350px]">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Porcentaje de avance general (Autocensadas + Censo Presencial)
							</CardDescription>
						</CardHeader>
						<CardContent>
							<ProgressIndicator
								total={data.total}
								completed={
									data.resumenEstados.autocensadas +
									data.resumenEstados.presencial
								}
